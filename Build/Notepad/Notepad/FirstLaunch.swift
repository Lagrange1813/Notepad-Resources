...
func firstStart() {
    let title0 = "卡拉马佐夫兄弟"
    let author0 = "陀思妥耶夫斯基"
    saveBook(title: title0, author: author0)
    
    let title00 = "一颗炽热的心的自白（故事体）"
    ...
    saveText(title: title00, body: body00, type: "Text")
    saveText(title: title01, body: body01, type: "Text")
    saveText(title: title02, body: body02, type: "Text")
    
    let book1 = "白夜"
    let author1 = "陀思妥耶夫斯基"
    saveBook(title: book1, author: author1)
    ...
    saveText(title: title10, body: body10, type: "Text", bookName: "白夜")
    saveText(title: title11, body: body11, type: "Text", bookName: "白夜")
    saveText(title: title12, body: body12, type: "Text", bookName: "白夜")
