...
export declare const hidePanel: (vditor: LGEditor, panels: string[], exceptElement?: HTMLElement) => void;
export declare const toggleSubMenu: (vditor: LGEditor, panelElement: HTMLElement, actionBtn: Element, level: number) => void;
