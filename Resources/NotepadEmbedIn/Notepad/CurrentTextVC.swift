...
//        navigationController?.navigationBar.barStyle = .black
    ...
    func configureTextView() {
        let backLayer = UIScrollView(frame: CGRect(x: 0, y: 0, width: 350, height: 300))
        backLayer.backgroundColor = .yellow
        backLayer.isScrollEnabled = true
//        backLayer.alwaysBounceVertical = false
//        backLayer.alwaysBounceHorizontal = false
//        backLayer.contentSize = CGSize(width: 0, height: 50)
        
        articleField = PureTextView(frame: CGRect(x: 10, y: 10, width: 300, height: 1000), textContainer: nil)
        articleField.delegate = self
        customTextStyle(articleField)
        
        view.addSubview(backLayer)
        backLayer.addSubview(articleField)
...
//        articleField.contentSize = CGSize(width: 0, height: 100)
...
//        }
    ...
    func customTextStyle(_ articleField: PureTextView) {
...
//        articleField.textContainerInset = UIEdgeInsets(top: 20, left: 0, bottom: 20, right: 0)
//        articleField.textAlignment = .justified
