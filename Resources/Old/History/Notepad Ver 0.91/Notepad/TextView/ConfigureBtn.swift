...
//                self.view.layoutIfNeeded()
    ...
    func configureTouchPadHandler() {
        toolBar.touchPad.isHidden = false
        
        let velocityMultiplier: CGFloat = 5
        ...
        toolBar.touchPad.handler = { [unowned self] data in
...
//            print(data.velocity)
        ...
        toolBar.touchPad.handleTouchEnded = { [unowned self] in
            print("ended")
